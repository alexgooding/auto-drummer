...
Everything necessary to generate the patterns themselves is listed below or included in the installer for Windows/Wine users. 
...
If you are not using Windows OS or Wine, to deploy from the command line, several packages are required as well as a Python 2.X or 3.X build. 
...
```
Users not using Windows/Wine will need to also install the Clingo package. Please consult https://github.com/potassco/clingo/releases for more information. The most simple method for installation is with conda. i.e.
